  ...
  //   const colorConfig = Object.entries(config).filter(([_, conf]) => conf.color || conf.theme)
  ...
  //   color?: string
  //   formatter?: (value: any, name?: string, item?: PayloadItem) => React.ReactNode
  // }
  ...
  //   }, [payload, hideLabel, label, labelClassName, labelKey, config])
  ...
  //               )}
  //             >
  //               {formatter && item?.value !== undefined ? formatter(item.value, item.name, item) : null}
  //               {!formatter && !hideIndicator && (
  //                 <div
  //                   className={cn(
  ...
  // // ================== Helper ==================
  // function getPayloadConfig(config: ChartConfig, payloadItem: PayloadItem, key: string) {
  //   return config[key] || config[key as keyof typeof config] || undefined
  // }

  // // ================== Exports ==================
  // export { Tooltip as ChartTooltip, ChartTooltipContent, Legend as ChartLegend, ChartLegendContent, ChartStyle }